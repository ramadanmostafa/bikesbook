$(window).load(function() {
    ...
    $("a#open-more-info").on("click", function() {
      ...
      var contents = $("#right-side .content");
      var buttons = $("a#open-more-info");
      buttons.removeClass("active");
      $("a#open-more-info[data-target='" + this.getAttribute("data-target") + "']").addClass("active");
	  $(this).addClass("active");
    	
    if($("#right-side").hasClass('hide-right')) //closed
    {
    	contents.hide();   	
    	$("#right-side").find(target).show();
    	...
    	if($("#right-side").find(target).css('display') == 'none') //hidden
    {contents.hide();
    	$("#right-side").find(target).show();}
    	...
    	$("a#open-more-info").removeClass("active"),
